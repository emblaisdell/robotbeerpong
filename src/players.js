...
//   v = isqrt( g * range * 0.785 )     (the 0.785 folds in the launch-height
...
start:
    ...
    # a0 = g * range * 785 / 1000   (ordered to avoid 32-bit overflow)
    li   t1, 785
    mul  a0, s2, t1
    li   t1, 1000
    div  a0, a0, t1
...
start:
    ...
    sw   t1, 0(t0)
    li   t0, A_POWER
    li   t1, 3100          # fixed, tuned for the middle of the rack
    sw   t1, 0(t0)
    li   t0, A_FIRE
    li   t1, 1
    sw   t1, 0(t0)
